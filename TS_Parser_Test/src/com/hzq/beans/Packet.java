...
public class Packet {
	...
	public String toString() {
		return "Packet [syncByte=0x" + Integer.toHexString(syncByte) + ", transportErrorIndicator=" + transportErrorIndicator
				+ ", payloadUnitStartIndicator=" + payloadUnitStartIndicator + ", transportPriority="
				+ transportPriority + ", pid=" + pid + ", transportScrambingControl=" + transportScrambingControl
				+ ", adaptationFieldControl=" + adaptationFieldControl + ", continuityCounter=" + continuityCounter
				+ ", packet=" + byte2hex(packet) + "]";
	}
