...
//	8bit
	...
	public String toString() {
		return "Section [tableId=" + tableId + ", sectionSyntaxIndicator=" + sectionSyntaxIndicator + ", zero=" + zero
				+ ", reserved1=" + reserved1 + ", sectionLenth=" + sectionLenth + ", transportStreamId="
				+ transportStreamId + ", reserver2=" + reserver2 + ", versionNumber=" + versionNumber
				+ ", currentNextIndicator=" + currentNextIndicator + ", sectionNumber=" + sectionNumber
				+ ", lastSectionNumber=" + lastSectionNumber + ", sectionData=" + Arrays.toString(sectionData) + "]";
	}
